% Chapter 3 reference resources. Included by ch03_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch03-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~3. The
...
\caption{Key terms for Chapter 3}
\label{tab:comp-ch03-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 3}
\label{tab:comp-ch03-instrument-status}\\
\toprule
...
\label{eq:comp-ch03-reference-formula}
\end{equation}
