...
Core consolidated process aligned to Chapter 3 and Resource Set C.

## Process steps

### 1. Define the institutional-risk context
Identify rights, affected groups, consequence, and mandatory obligations relevant to Human Oversight and Accountability Matrix.
...
Assign decision rights, review duties, escalation, pause, update, restart, and retirement authority.
