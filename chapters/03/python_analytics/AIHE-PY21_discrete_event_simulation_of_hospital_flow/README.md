# AIHE-PY21 — Discrete-event simulation of hospital flow

**Version:** V1.0 
**Primary chapter:** 3. Human–AI Decision Support and Managerial Action 
**Additional chapter alignment:** 3, 8 
**Related companion resources:** AIHE-B05, AIHE-C04 
**Data classification:** Synthetic example data only

## Purpose

Simulates arrivals, queues, service times, capacity, prioritization, and delays to assess how AI-enabled triage or scheduling affects operations.
...
`Scenarios` sheet with scenario, arrival rate, service rate, number of servers, priority accuracy, and operating hours; `Parameters` sheet with replications and warm-up hours.
...
Replication-level wait, queue, utilization, throughput, delay-cost results; scenario summary; uncertainty intervals; waiting-time chart.
