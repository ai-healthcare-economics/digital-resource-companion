% Chapter 8 reference resources. Included by ch08_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch08-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~8. The
...
\caption{Key terms for Chapter 8}
\label{tab:comp-ch08-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 8}
\label{tab:comp-ch08-instrument-status}\\
\toprule
...
\label{eq:comp-ch08-reference-formula}
\end{equation}
