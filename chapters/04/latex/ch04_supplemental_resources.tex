% Chapter 4 supplemental resources. Included by ch04_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch04-supplemental}

These supplemental resources translate the Chapter~4 concepts into editable
...
\caption{Chapter 4 supplemental-resource set}
\label{tab:comp-ch04-supplemental-set}\\
\toprule
...
\subsection{Productivity-Realization Chain}
\label{sec:comp-ch04-supp-1}
...
\label{tab:comp-ch04-spec-fields}\\
\toprule
...
\subsection{Determinant-to-Strategy Matrix}
\label{sec:comp-ch04-supp-2}
...
\begin{enumerate}
 \item Map the full documentation workflow and distinguish drafting assistance from coding or downstream recommendations..
 \item Measure gross time, review, correction, escalation, and coordination by professional role..
 \item Assess whether net time can be pooled or scheduled as usable capacity..
 \item Evaluate quality, privacy, consent, patient interaction, and after-hours work alongside throughput..
 \item Use CFIR, NASSS-CAT, or another selected implementation resource for a defined purpose rather than as a generic checklist..
 \item Define benefit owners, renewal thresholds, and controls for model, prompt, and template updates..
\end{enumerate}

\subsection{Implementation and Sustainment Record}
\label{sec:comp-ch04-supp-3}
...
\label{tab:comp-ch04-decision-record}\\
\toprule
