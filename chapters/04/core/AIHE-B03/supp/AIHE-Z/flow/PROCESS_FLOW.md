...
Define perspective, comparator, population, horizon, and decision rule for ROI and Workflow Value Worksheet.
...
Distinguish gross time saved, review burden, capacity released, capacity used, and realized value.
