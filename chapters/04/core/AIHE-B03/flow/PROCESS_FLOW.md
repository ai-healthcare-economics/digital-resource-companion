...
Core consolidated process aligned to Chapter 4 and Resource Set B.

## Process steps

### 1. Specify the economic decision
Define perspective, comparator, population, horizon, and decision rule for Benefit Realization and Capacity Conversion.
...
Trace gross benefits through review burden, released capacity, redeployment, outcomes, and verified realization.
