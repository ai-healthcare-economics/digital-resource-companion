% Chapter 7 supplemental resources. Included by ch07_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch07-supplemental}

These supplemental resources translate the Chapter~7 concepts into editable
...
\caption{Chapter 7 supplemental-resource set}
\label{tab:comp-ch07-supplemental-set}\\
\toprule
...
\subsection{Economic Evaluation Protocol}
\label{sec:comp-ch07-supp-1}
...
\label{tab:comp-ch07-spec-fields}\\
\toprule
...
\subsection{Budget-Impact Record}
\label{sec:comp-ch07-supp-2}
...
\begin{enumerate}
 \item Specify decision-maker, perspective, comparator, population, horizon, and intended scale..
 \item Estimate incremental costs, effects, QALYs, and net benefit..
 \item Present annual and cumulative budget impact under uptake scenarios..
 \item Separate economic cost from cash flow and productive capacity from cash-releasing savings..
 \item Assess subgroup access, connectivity, digital support, and distribution of opportunity cost..
 \item Identify whether remaining uncertainty should lead to adoption, a restricted pilot, price negotiation, or further research..
\end{enumerate}

\subsection{HTA and Local-Adoption Decision Record}
\label{sec:comp-ch07-supp-3}
...
\label{tab:comp-ch07-decision-record}\\
\toprule
