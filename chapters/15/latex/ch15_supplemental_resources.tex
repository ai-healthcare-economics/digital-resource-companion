% Chapter 15 supplemental resources. Included by ch15_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch15-supplemental}

These supplemental resources translate the Chapter~15 concepts into editable
...
\caption{Chapter 15 supplemental-resource set}
\label{tab:comp-ch15-supplemental-set}\\
\toprule
...
\subsection{Circularity-Adjusted Evaluation Protocol}
\label{sec:comp-ch15-supp-1}
...
\label{tab:comp-ch15-spec-fields}\\
\toprule
...
\subsection{Environmental and Material Evidence Record}
\label{sec:comp-ch15-supp-2}
...
\begin{enumerate}
 \item Define the functional unit, perspective, system boundary, horizon, and comparators..
 \item Combine lifecycle costing with physical energy, water, material, residual-value, and resilience evidence..
 \item Report impacts separately where monetization is not credible..
 \item Estimate resource intensity and absolute demand, including rebound under growth scenarios..
 \item Use circularity-adjusted net benefit only with consistent valuation, no double counting, and explicit limitations..
 \item Apply multi-criteria deliberation after mandatory safety, privacy, cybersecurity, continuity, and equity safeguards are met..
\end{enumerate}

\subsection{Multi-Criteria Deliberation and Safeguards}
\label{sec:comp-ch15-supp-3}
...
\label{tab:comp-ch15-decision-record}\\
\toprule
