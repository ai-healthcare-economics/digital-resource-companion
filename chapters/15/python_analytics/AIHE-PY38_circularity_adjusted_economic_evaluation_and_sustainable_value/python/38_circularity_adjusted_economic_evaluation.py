"""Self-contained runner: Circularity-adjusted economic evaluation and sustainable value.
...
from aihe_analytics.module_38_circularity_adjusted_economic_evaluation import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "38_circularity_adjusted_economic_evaluation_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Circularity-adjusted economic evaluation and sustainable value')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Circularity-adjusted economic evaluation and sustainable value")
