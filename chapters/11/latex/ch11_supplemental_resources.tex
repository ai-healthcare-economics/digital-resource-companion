% Chapter 11 supplemental resources. Included by ch11_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch11-supplemental}

These supplemental resources translate the Chapter~11 concepts into editable
...
\caption{Chapter 11 supplemental-resource set}
\label{tab:comp-ch11-supplemental-set}\\
\toprule
...
AIHE-EX05 Local Validation Report and Silent Evaluation & Define scope, owner, evidence source, assumptions, decision threshold, review date, and required action. & Blank record, synthetic example, and version history. \\
...
\subsection{Evidence Maturity and Appraisal}
\label{sec:comp-ch11-supp-1}
...
\label{tab:comp-ch11-spec-fields}\\
\toprule
...
\subsection{AIHE-EX05: Local Validation and Silent Evaluation}
\label{sec:comp-ch11-supp-2}
The editable AIHE-EX05 Local Validation Report Template is the preferred structured record for this activity. It preserves the exact system version, local cohort, calibration, threshold-specific performance, subgroup findings, workflow evidence, clinical utility, uncertainty, and decision conditions.
...
\begin{enumerate}
 \item Define the intended use, threshold, action, capacity, and exact system version..
 \item Assess data design, leakage, transportability, discrimination, calibration, threshold-specific utility, and subgroup performance..
 \item Conduct silent evaluation before clinical dependence..
 \item Separate model validation from causal evaluation of the follow-up intervention..
 \item Use an appropriate randomized, quasi-experimental, or target-trial design to estimate service effects..
 \item Combine technical, clinical, implementation, qualitative, economic, governance, and post-deployment evidence in a decision-ready record..
\end{enumerate}

\subsection{Causal and Real-World Evaluation Protocol}
\label{sec:comp-ch11-supp-3}
...
\label{tab:comp-ch11-decision-record}\\
\toprule
