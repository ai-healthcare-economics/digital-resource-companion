# AIHE-PY05 — Model performance, threshold trade-offs, and calibration
...
Calculates ROC AUC, Brier score, confusion-matrix measures across thresholds, calibration intercept and slope, and calibration bins.
...
```bash
python python/05_performance_and_calibration.py
```
...
`Predictions` sheet with actual outcome, predicted score, and optional subgroup.
...
Threshold-performance table, ROC curve, threshold trade-off chart, calibration plot, and calibration statistics.
