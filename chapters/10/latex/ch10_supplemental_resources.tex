% Chapter 10 supplemental resources. Included by ch10_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch10-supplemental}

These supplemental resources translate the Chapter~10 concepts into editable
...
\caption{Chapter 10 supplemental-resource set}
\label{tab:comp-ch10-supplemental-set}\\
\toprule
...
\subsection{Governance and Accountability Record}
\label{sec:comp-ch10-supp-1}
...
\label{tab:comp-ch10-spec-fields}\\
\toprule
...
\subsection{Integrated Institutional-Risk Register}
\label{sec:comp-ch10-supp-2}
...
\begin{enumerate}
 \item Define allowed, prohibited, and escalation-required tasks..
 \item Map data flows, third parties, retention, logging, and model-service dependencies..
 \item Assess factuality, information integrity, privacy, cybersecurity, language, accessibility, and digital inclusion..
 \item Estimate the effect on call-centre demand, repeat contacts, abandonment, and downstream services..
 \item Assign accountability, incident communication, contestability, and stopping authority..
 \item Pilot only where essential non-digital routes remain available and monitoring can detect differential use and harm..
\end{enumerate}

\subsection{Patient-Facing AI Assurance Record}
\label{sec:comp-ch10-supp-3}
...
\label{tab:comp-ch10-decision-record}\\
\toprule
