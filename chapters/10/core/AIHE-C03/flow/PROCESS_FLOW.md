...
Core consolidated process aligned to Chapter 10 and Resource Set C.

## Process steps

### 1. Define the institutional-risk context
Identify rights, affected groups, consequence, and mandatory obligations relevant to Integrated Institutional-Risk Review.
...
Integrate ethics, equity, privacy, cybersecurity, resilience, legal, quality, and trust risks with mandatory safeguards.

## Related resource IDs

`AIHE-C`, `AIHE-AB`, `AIHE-AC`, `AIHE-N`
