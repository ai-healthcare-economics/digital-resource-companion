...
Primary lifecycle stage: Assess governance and institutional risk. Primary book chapter: 1.

## Process steps

### 1. Define the institutional-risk context
Identify rights, affected groups, consequence, and mandatory obligations relevant to Trust, Equity, and Public Value Workbook.
...
Integrate trust-adjusted value, distributional effects, mitigation, public value, confidence, and mandatory safeguards.
