...
**Additional chapter alignment:** 7, 10, 11, 15 
**Related companion resources:** AIHE-C03 
**Data classification:** Synthetic example data only

## Purpose

Compares AUC, calibration, sensitivity, specificity, predictive values, and selection rates across population groups.
...
```bash
python python/08_subgroup_equity_audit.py
```
...
`Predictions` sheet with actual outcome, predicted score, subgroup, and threshold.
...
Subgroup audit table, disparity summary, sensitivity chart, calibration overview, and largest-gap indicator.
