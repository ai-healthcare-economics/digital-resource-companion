...
**Additional chapter alignment:** 3, 10, 11 
**Related companion resources:** AIHE-C03 
**Data classification:** Synthetic example data only

## Purpose

Fits a tree ensemble, calculates permutation importance, and visualizes the relationship between the top feature and predicted risk.
...
```bash
python python/07_feature_importance_explainability.py
```
...
`Data` sheet with outcome and numeric predictors.
...
Permutation-importance table and chart, partial-dependence chart, and test AUC.
