...
Core consolidated process aligned to Chapter 6 and Resource Set B.

## Process steps

### 1. Specify the economic decision
Define perspective, comparator, population, horizon, and decision rule for Economic Evaluation Specification.
...
Specify perspective, comparators, costs, outcomes, time horizon, uncertainty, distribution, and decision rules.
