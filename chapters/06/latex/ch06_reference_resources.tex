% Chapter 6 reference resources. Included by ch06_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch06-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~6. The
...
\caption{Key terms for Chapter 6}
\label{tab:comp-ch06-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 6}
\label{tab:comp-ch06-instrument-status}\\
\toprule
...
\label{eq:comp-ch06-reference-formula}
\end{equation}
