% Chapter 6 supplemental resources. Included by ch06_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch06-supplemental}

These supplemental resources translate the Chapter~6 concepts into editable
...
\caption{Chapter 6 supplemental-resource set}
\label{tab:comp-ch06-supplemental-set}\\
\toprule
...
\subsection{Lifecycle Cost Log}
\label{sec:comp-ch06-supp-1}
...
\label{tab:comp-ch06-spec-fields}\\
\toprule
...
\subsection{Pricing and Volume Scenarios}
\label{sec:comp-ch06-supp-2}
...
\begin{enumerate}
 \item Define perspective, price year, time horizon, comparator, and full cost boundary..
 \item Classify costs as fixed, step-fixed, variable, contingent, shared, or exit related..
 \item Model low, expected, and high activity for each pricing structure..
 \item Discount costs and credible monetised benefits; preserve non-monetised value separately..
 \item Create a benefit-realization register that distinguishes cash savings, avoided costs, usable capacity, quality, workforce, and public value..
 \item Test price, uptake, review burden, implementation delay, support, and exit thresholds..
\end{enumerate}

\subsection{Benefit-Realization Register}
\label{sec:comp-ch06-supp-3}
...
\label{tab:comp-ch06-decision-record}\\
\toprule
