% Chapter 14 supplemental resources. Included by ch14_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch14-supplemental}

These supplemental resources translate the Chapter~14 concepts into editable
...
\caption{Chapter 14 supplemental-resource set}
\label{tab:comp-ch14-supplemental-set}\\
\toprule
...
\subsection{Asset Option Appraisal}
\label{sec:comp-ch14-supp-1}
...
\label{tab:comp-ch14-spec-fields}\\
\toprule
...
\subsection{Maintenance and Supportability Record}
\label{sec:comp-ch14-supp-2}
...
\begin{enumerate}
 \item Define functional service requirements and non-negotiable safety, support, cybersecurity, and continuity conditions..
 \item Compare lifecycle cost and equivalent annual cost only among eligible options..
 \item Assess compatibility, validation burden, downtime, maintainability, software support, energy, residual value, and exit..
 \item Examine reuse, refurbishment, transfer, take-back, secure erasure, and chain of custody..
 \item Test downside scenarios for failure, vendor exit, delayed migration, and demand growth..
 \item Document the transition, data closure, receiving party, final destination, and organizational learning..
\end{enumerate}

\subsection{Decommissioning and Disposition Record}
\label{sec:comp-ch14-supp-3}
...
\label{tab:comp-ch14-decision-record}\\
\toprule
