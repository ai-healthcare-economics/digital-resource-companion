% Chapter 2 supplemental resources. Included by ch02_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch02-supplemental}

These supplemental resources translate the Chapter~2 concepts into editable
...
\caption{Chapter 2 supplemental-resource set}
\label{tab:comp-ch02-supplemental-set}\\
\toprule
...
\subsection{Use-Case Readiness Profile}
\label{sec:comp-ch02-supp-1}
...
\label{tab:comp-ch02-spec-fields}\\
\toprule
...
\subsection{Data and Interoperability Evidence Record}
\label{sec:comp-ch02-supp-2}
...
\begin{enumerate}
 \item Specify the data, timing, and workflow dependencies of the intended use..
 \item Assess readiness by use case rather than by one maturity score..
 \item Identify which weaknesses affect several proposed services and estimate their portfolio-level reuse value..
 \item Compare immediate procurement with a foundation-first sequence and a restricted proof of concept..
 \item Define acceptance criteria for identity, semantics, provenance, latency, resilience, and governance..
 \item Record which standards are implementation tools and which local mappings and controls remain necessary..
\end{enumerate}

\subsection{Foundation Investment and Portfolio Reuse}
\label{sec:comp-ch02-supp-3}
...
\label{tab:comp-ch02-decision-record}\\
\toprule
