...
Core consolidated process aligned to Chapter 1 and Resource Set A.

## Process steps

### 1. Confirm the initiating problem
Clarify why Stakeholders, Decision Rights, and Participation is needed and what decision it supports.
...
Identify affected groups, accountable authorities, specialist duties, participation, and escalation rights.
