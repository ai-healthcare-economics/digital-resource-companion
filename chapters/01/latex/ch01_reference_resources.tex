% Chapter 1 reference resources. Included by ch01_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch01-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~1. The
...
\caption{Key terms for Chapter 1}
\label{tab:comp-ch01-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 1}
\label{tab:comp-ch01-instrument-status}\\
\toprule
...
\label{eq:comp-ch01-reference-formula}
\end{equation}
