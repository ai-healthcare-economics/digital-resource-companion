% Chapter 12 reference resources. Included by ch12_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch12-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~12. The
...
\caption{Key terms for Chapter 12}
\label{tab:comp-ch12-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 12}
\label{tab:comp-ch12-instrument-status}\\
\toprule
...
\label{eq:comp-ch12-reference-formula}
\end{equation}
