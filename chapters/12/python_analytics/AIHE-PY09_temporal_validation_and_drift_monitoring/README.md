...
**Additional chapter alignment:** 11, 12 
**Related companion resources:** AIHE-D03, AIHE-D05, AIHE-B05 
**Data classification:** Synthetic example data only

## Purpose

Tracks discrimination, calibration error, score distribution, and feature drift across time periods.
...
```bash
python python/09_temporal_validation_and_drift.py
```
...
`Monitoring` sheet with period, actual outcome, score, feature 1, and feature 2.
...
Period-level AUC and Brier score, PSI and KS drift measures, review flags, and performance/drift charts.
