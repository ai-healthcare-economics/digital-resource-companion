"""Self-contained runner: AI-HED completeness and institutional decision-quality audit.
...
from aihe_analytics.module_29_integrated_decision_dossier import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "29_integrated_decision_dossier_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='AI-HED completeness and institutional decision-quality audit')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: AI-HED completeness and institutional decision-quality audit")
