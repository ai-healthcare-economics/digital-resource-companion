% Chapter 13 supplemental resources. Included by ch13_resources.tex.
\section{Supplemental Resources}
\label{sec:comp-ch13-supplemental}

These supplemental resources translate the Chapter~13 concepts into editable
...
\caption{Chapter 13 supplemental-resource set}
\label{tab:comp-ch13-supplemental-set}\\
\toprule
...
\subsection{Circularity Hierarchy and Opportunity Register}
\label{sec:comp-ch13-supp-1}
...
\label{tab:comp-ch13-spec-fields}\\
\toprule
...
\subsection{Resource-Flow and Intensity Record}
\label{sec:comp-ch13-supp-2}
...
\begin{enumerate}
 \item Define a clinically meaningful functional unit and map material, energy, water, data, and service flows..
 \item Apply the circularity hierarchy before assuming that new acquisition is required..
 \item Compare prevention, reduction, maintenance, sharing, reuse, refurbishment, replacement, and recovery options..
 \item Assess whether AI-enabled forecasting or maintenance changes an actual resource decision..
 \item Measure resource intensity and total demand to detect rebound..
 \item Evaluate resilience, equity, supplier dependence, burden transfer, and final disposition..
\end{enumerate}

\subsection{Circular Operating Capability Assessment}
\label{sec:comp-ch13-supp-3}
...
\label{tab:comp-ch13-decision-record}\\
\toprule
