% Chapter 13 reference resources. Included by ch13_resources.tex.
\section{Reference Resources}
\label{sec:comp-ch13-reference}

This reference section distinguishes concepts, methods, reporting guidance,
standards, regulations, and author-developed tools used with Chapter~13. The
...
\caption{Key terms for Chapter 13}
\label{tab:comp-ch13-key-terms}\\
\toprule
...
\caption{Selected instruments relevant to Chapter 13}
\label{tab:comp-ch13-instrument-status}\\
\toprule
...
\label{eq:comp-ch13-reference-formula}
\end{equation}
