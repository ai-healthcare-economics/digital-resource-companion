"""Self-contained runner: Environmental, material-flow, and lifecycle resource accounting.
...
from aihe_analytics.module_36_circular_economy_material_carbon_cost import run_analysis


def main() -> None:
    default_input = ROOT / "data" / "xlsx" / "36_circular_economy_material_carbon_cost_sample.xlsx"
    default_output = ROOT / "outputs" / "generated"
    parser = argparse.ArgumentParser(description='Environmental, material-flow, and lifecycle resource accounting')
    parser.add_argument(
        "--input",
    ...
    print(f"Completed: Environmental, material-flow, and lifecycle resource accounting")
